...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1A0E0B] text-gray-300 pt-14 pb-6 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ul className="space-y-2.5">
              {quickLinks.map(l => (
                <li key={l.href}>
                  ...
                  >
                    <span className="w-1 h-1 rounded-full bg-[#D85A30] opacity-0
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between
          gap-3 pt-6 text-xs text-gray-500">
          <span>© {year} DishDrop. All rights reserved.</span>
